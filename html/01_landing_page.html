...
<body>
  ...
  <section>
    <div class="banner">
      ...
      <a href="02_sign-up.html" class="botao-criar-conta-banner">Criar conta</a>
    </div>
  </section>
  ...
  <section class="blocos">
    ...
    <img  src="/pictures/brazil.png" alt="Desenho do mapa do Brasil" class="blocos__img">
  </section>
  ...
  <section class="blocos_imagem_background">
    ...
    <div class="bloco__descricao">
      ...
      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed ipsum hac facilisi sem vestibulum, molestie sit pulvinar.</p>
      <a href="02_sign-up.html" class="botao-criar-conta">Criar conta</a>
    </div>
  </section>
  ...
  <section class="blocos">
    ...
    <img  src="/pictures/planet-earth.png" alt="Desenho do planeta Terra rodeado por uma folha de planta" class="blocos__img">
  </section>
  ...
  <footer class="rodape">
    <img src="/pictures/logo-preta.png">
