  ...
  <section class="barra-lateral-navegacao">
    ...
    <article class="descricao-pagina">
      ...
      <p>Aqui você poderá alterar seus dados cadastrais como endereço de entrega, dados do seu cartão de crédito e telefone</p>
        ...
        <form class=formulario-perfil action="formulario-perfil-atualizar-dados">
   
          <label for="nomecompleto">Nome completo<label>
          <input type="text" id="nomecompleto" class="input-padrao-perfil" required placeholder="Nome completo"/>
    
          <label for="endereco">Endereço<label>
          <input type="text" id="endereco" class="input-padrao-perfil" required placeholder="Endereço"/>
    
          <label for="cpf">Telefone<label>
          <input type="number" id="telefone" class="input-padrao-perfil" required placeholder="Telefone"/>
    
          <label for="email">Email<label>
          <input type="email" id="email" class="input-padrao-perfil" required placeholder="seuemail@dominio.com" />
    
          <label for="senha">Cartão de crédito<label>
          <input type="number" id="cartao-de-credito" class="input-padrao-perfil" required placeholder="**** **** **** ****"/>
