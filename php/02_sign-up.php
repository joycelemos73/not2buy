  ...
  <main>
    <section class="signup">
     ...
     <form class=formulario-signup action="formulario-cadastro-incial.php" method="post">
      ...
      <input type="text" name="nomecompleto" id="nomecompleto" class="input-padrao" required placeholder="Digite aqui o seu nome completo"/>

      <label for="endereco">Endereço<label>
      <input type="text" name="endereco" id="endereco" class="input-padrao" required placeholder="Digite aqui o seu endereço completo"/>

      <label for="cpf">CPF<label>
      <input type="number" name="cpf" id="cpf" class="input-padrao" required placeholder="Digite aqui o seu número de CPF"/>
